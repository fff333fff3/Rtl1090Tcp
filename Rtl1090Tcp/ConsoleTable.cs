...
namespace Rtl1090Tcp
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = Rtl1090Tcp.Format.Default)
        {
            switch (format)
            {
                case Rtl1090Tcp.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Rtl1090Tcp.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Rtl1090Tcp.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Rtl1090Tcp.Format.Minimal:
